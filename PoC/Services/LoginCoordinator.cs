...
// Tracks in-flight logins by Telegram user ID so the driver
// (console UI, bot, etc.) can submit phone/code/password asynchronously
internal sealed class LoginCoordinator
{
