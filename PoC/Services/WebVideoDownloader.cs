...
/// (YouTube, Instagram, TikTok, X, Reddit, Twitch, Vimeo, …).
/// </summary>
internal sealed class WebVideoDownloader
{
    ...
    public async Task<string?> DownloadAsync(string url, bool audioOnly, CancellationToken ct)
    {
