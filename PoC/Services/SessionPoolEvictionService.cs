...
/// <summary>
/// Periodically evicts WTelegramClient instances that have been idle longer than
/// <see cref="SessionOptions.IdleEvictionMinutes"/>. The encrypted session blob
/// stays in Postgres so the next request rehydrates instantly.
/// </summary>
internal sealed class SessionPoolEvictionService : BackgroundService
{
